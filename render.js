  ...
  function (e, t, n) {
    ...
    function A(e) {
      ...
      var B = {
        ...
        push(e, t) {
          let n = m(e, void 0, void 0, B.location);
    ...
    e.exports = (function e(t) {
          ...
          if (
            ...
            if (Ee === 1) {switch (y) {
                ...
                case W:
                  break;
                default:
                  for (Ee = 0, Oe = Y, v = y, Y--, y = N; Oe < Pe;) switch (a.charCodeAt(Oe++)) {
                      case L:
                      case B:
                      case N:
                        ++Y, (y = v), (Oe = Pe);
                    ...
                    if (
                      ...
                      Oe > 0)
                        ...
                        case q:
                          ...
                          break;
                        case ie:
                          (Ke =                            (Ge = Ge.replace(h, '$1 $2' + (De > 0 ? Ie : '')))
                            + "{"
                            + Ke
                            + "}"),
      ...
      function Le(e, t, n) {
        ...
        switch (o) {
          case 0:
          case 1:
            for (var l = 0, s = o === 0 ? '' : `${e[0] } `; l < i; ++l) a[l] = Be(s, a[l], n, o).trim();
            break;
          default:
            l = 0;
            var u = 0;
            for (a = []; l < i; ++l) for (let d = 0; d < o; ++d) a[u++] = Be(`${e[d]} `, r[l], n, o).trim();
        }
        return a;
      }
      function Be(e, t, n, r) {
      ...
      function Ve(e, t, n, r, a, i, o, l, s, u) {
        for (var c, d = 0, f = t; d < Ce; ++d) {switch ((c = Ee[d].call(Ge, e, f, n, r, a, i, o, l, s, u))) {
            case void 0:
            case !1:
            case !0:
            case null:
      ...
      function qe(e, t, n, r) {
        for (var a = t + 1; a < n; ++a) {switch (r.charCodeAt(a)) {
            case J:
              if (e === G && r.charCodeAt(a - 1) === G && t + 2 !== a) return a + 1;
              break;
            case L:
              if (e === J) return a + 1;
          }}
...
onClick: function (t) {
  ...
  function (e, t, n) {
    ...
    var Z = J ? Symbol.for('react.element') : 60103;
    var ee = J ? Symbol.for('react.portal') : 60106;
    var te = J ? Symbol.for('react.fragment') : 60107;
    var ne = J ? Symbol.for('react.strict_mode') : 60108;
    var re = J ? Symbol.for('react.profiler') : 60114;
    var ae = J ? Symbol.for('react.provider') : 60109;
    var ie = J ? Symbol.for('react.context') : 60110;
    var oe = J ? Symbol.for('react.concurrent_mode') : 60111;
    var le = J ? Symbol.for('react.forward_ref') : 60112;
    var se = J ? Symbol.for('react.suspense') : 60113;
    var ue = J ? Symbol.for('react.suspense_list') : 60120;
    var ce = J ? Symbol.for('react.memo') : 60115;
    var de = J ? Symbol.for('react.lazy') : 60116;
    var fe = J ? Symbol.for('react.block') : 60121;
    ...
    var Ye = Ve('animationiteration');
    var Ge = Ve('animationstart');
    ...
    function Hn() {
      ...
      var n = Bn;
      var r = n.length;
      var a = 'value' in Ln ? Ln.value : Ln.textContent;
      var i = a.length;
    ...
    var Xn = [9, 13, 27, 32];
    var Jn = T && 'CompositionEvent' in window;
    var Zn = null;
    T && 'documentMode' in document && (Zn = document.documentMode);
    const er = T && 'TextEvent' in window && !Zn;
    var tr = T && (!Jn || (Zn && Zn > 8 && Zn <= 11));
      ...
      extractEvents(e, t, n, r) {
        ...
        return (
          ...
          (e = er
            ...
            : (function (e, t) {
              if (lr) return 'compositionend' === e || (!Jn && ir(e, t))
    ...
    function qa(e) {
      return ja === null ? ((ja = [e]), (Ra = ka(Pa, Ga))) : ja.push(e), Fa;
    }
    function Ya() {
      if (Ra !== null) {
        const e = Ra;
    ...
    function Ga() {
      if (!za && ja !== null) {
        ...
        try {
          ...
          throw (ja !== null && (ja = ja.slice(e + 1)), ka(Pa, Ya), n);
        } finally {
          za = !1;
        }
      }
    ...
    const Li = Q.ReactCurrentDispatcher;
    var Bi = Q.ReactCurrentBatchConfig;
    var Ui = 0;
    var Hi = null;
    var Wi = null;
    var Vi = null;
    ...
    function Ki(e, t, n, r, a, i) {
      if (
        ...
        (t.updateQueue = null),
        (t.expirationTime = 0),
        (Li.current = e === null || e.memoizedState === null ? bo : yo),
        (e = n(r, a)),
        t.expirationTime === Ui)
      ) {
        i = 0;
    ...
    function ao(e, t, n, r) {
      ...
      if (Wi !== null) {
        ...
        if (((i = o.destroy), r !== null && Gi(r, o.deps))) return void to(t, n, i, r);
      }
    ...
    function Do(e, t, n, r, a, i) {
      ...
      return (
        ...
        a < i
        && ((a = o.memoizedProps),
        (n = (n = n.compare) !== null ? n : Br)(a, r) && e.ref === t.ref)
          ? $o(e, t, i)
          : ((t.effectTag |= 1),
          ((e = Fs(o, r)).ref = t.ref),
          (e.return = t),
    ...
    function Qo(e, t, n) {
      ...
      if ((No(e, t, r.children, n), (2 & (r = ji.current)) !== 0)) (r = (1 & r) | 2), (t.effectTag |= 64);
        ...
        if (e !== null && (64 & e.effectTag) !== 0) {e: for (e = t.child; e !== null;) {
            if (e.tag === 13) e.memoizedState !== null && Go(e, n);
            else if (e.tag === 19) Go(e, n);
            ...
            (64 & t.effectTag) !== 0
              ...
              n
                  ...
                  || (1 & ji.current) !== 0
                    ? jl === Tl && (jl = Al)
                    : ((jl !== Tl && jl !== Al) || (jl = Ml),
                    Ul !== 0 && Fl !== null && (Bs(Fl, Il), Us(Fl, Ul)))),
              (n || r) && (t.effectTag |= 4),
              null)
          );
        case 4:
        ...
        case 19:
          ...
          if (((i = (64 & t.effectTag) !== 0), (l = r.rendering) === null)) {
            ...
            if (!i) {if ((e = Ri(l)) !== null) {
              ...
              } else 2 * Ba() - r.renderingStartTime > r.tailExpiration
                  && 1 < n
                  && ((t.effectTag |= 64),
                  (i = !0),
                  Xo(r, !1),
          ...
          return r.tail !== null
            ? (r.tailExpiration === 0 && (r.tailExpiration = Ba() + 500),
            (n = r.tail),
            (r.rendering = n),
            (r.tail = n.sibling),
    ...
    function as(e, t) {
      if (Zl > 50) throw ((Zl = 0), (es = null), Error(o(185)));
      if ((e = is(e, t)) !== null) {
        let n = Ua();
        t === 1073741823
    ...
    function is(e, t) {
      ...
      return (
        a !== null && (Fl === a && (ms(t), jl === Ml && Bs(a, Il)), Us(a, t)), a
      );
    }
    function os(e) {
              ...
              function e(t, n) {
                ...
                if (r !== 0) {
                  ...
                  if (
                    ...
                    if ((ei(), (Nl = a), (wl.current = i), jl === Ol)) throw ((n = Rl), ds(t, r), Bs(t, r), ls(t), n);
                    if (Dl === null) {switch (
    ...
    function ss(e) {
      ...
      if ((ks(), (e === Fl && t === Il) || ds(e, t), Dl !== null)) {
        ...
        if ((ei(), (Nl = n), (wl.current = r), jl === Ol)) throw ((n = Rl), ds(e, t), Bs(e, t), ls(e), n);
    ...
    function fs(e, t) {
      for (;;) {
        try {
          if ((ei(), (Li.current = vo), qi)) {for (let n = Hi.memoizedState; n !== null;) {
              let r = n.queue;
    ...
    function ys(e) {
      ...
      do {
        ...
        if (((e = Dl.return), (2048 & Dl.effectTag) === 0)) {
          if (((t = Jo(t, Dl, Il)), Il === 1 || Dl.childExpirationTime !== 1)) {
          ...
          if ((t = Zo(Dl)) !== null) return (t.effectTag &= 2047), t;
          e !== null
    ...
    function Os(e, t, n) {
      ...
      r !== null && r.delete(t),
      Fl === e && Il === n
        ? jl === Ml || (jl === Al && zl === 1073741823 && Ba() - Wl < Vl)
          ? ds(e, Il)
          : (Hl = !0)
        : Ls(e, n)
    ...
    bl = function (e, t, n) {
      ...
      switch (((t.expirationTime = 0), t.tag)) {
        ...
        case 3:
          if ((Bo(t), (r = t.updateQueue), e === null || r === null)) throw Error(o(282));
          if (
            ((r = t.pendingProps),
  ...
  function (e, t, n) {
    ...
    function z(e) {
      if (((j = !1), R(e), !I)) {if (T(A) !== null) (I = !0), r(L);
        else {
          let t = T(M);
    ...
    (t.unstable_scheduleCallback = function (e, n, o) {
      ...
      if (typeof o === 'object' && o !== null) {
        ...
        (o = typeof o.timeout === 'number' ? o.timeout : B(e));
      } else (o = B(e)), (s = l);
      return (
        (e = {
          id: _++,
...
s;
 ...
 color: a, dx: t, dy: n, blur: r, opacity: i 
  ...
  function (e, t, n) {
    ...
    const x = l.c.div(w());
    var S = l.c.div(y(), h.large);
    var k = l.c.div(b(), h.yellow);
    var E = l.c.div(v(), h.large);
    var C = l.c.p(g(), h.purple, h.medium);
    var T = function (e) {
      let t = e.entries;
    ...
    const ue = l.c.p(se());
    var ce = l.c.h4(le(), h.medium);
    var de = l.c.div(oe(), h.medium);
    var fe = function (e) {
      let t = e.title;
      var n = e.members;
      return a.a.createElement(
    ...
    const ye = l.c.div(be(), h.navy, h.medium);
    var we = l.c.div(ve());
    var xe = l.c.div(
      ge(),
      function (e) {
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              ...
              a.a.createElement(
                Se,
                null,
                r.slice(0, Math.floor(n.length / 2)).map((e) => a.a.createElement(fe, {
                      title: e.title,
                      members: e.members
                    })),
              ),
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              ...
              a.a.createElement(
                Se,
                null,
                n.slice(0, Math.floor(n.length / 3)).map((e) => a.a.createElement(fe, {
                      title: e.title,
                      members: e.members
                    })),
              ),
          ...
          a.a.createElement(
            ...
            a.a.createElement(
              ...
              a.a.createElement(
                Se,
                null,
                n.slice(0, Math.floor(n.length / 4)).map((e) => a.a.createElement(fe, {
                      title: e.title,
                      members: e.members
                    })),
              ),
    ...
    var Le = l.c.div(Te(), (e) => e.theme.small);
    const Be = function (e) {
      const t = e.id;
      var n = e.children;
      return a.a.createElement(
    ...
    const it = l.c.div(at(), h.purple);
    var ot = l.c.div(rt(), h.purple);
    var lt = l.c.div(nt());
    var st = l.c.div(tt());
    var ut = l.c.h3(et(), h.large);
    var ct = l.c.div(Ze(), h.large);
    var dt = l.c.p(Je(), h.large);
    var ft = l.c.a(Xe());
    var pt = function (e) {
      let t = e.title;
      var n = e.body;
      ...
      return a.a.createElement(
        ...
        a.a.createElement(
          ...
          a.a.createElement(
            ...
            a.a.createElement(st, null, a.a.createElement(ct, null, i)),
          ),
        ),
        a.a.createElement(
          c.MobileAndTablet,
    ...
    const Et = l.c.div(kt(), h.purple);
    var Ct = l.c.div(St(), h.purple);
    var Tt = l.c.div(xt());
    var Ot = l.c.div(wt());
    var Pt = l.c.div(yt());
    var At = l.c.h3(bt(), h.medium);
    var Mt = l.c.div(vt(), h.medium);
    var _t = l.c.p(gt());
    var Nt = l.c.a(mt());
    var Ft = l.c.h6(ht(), h.large);
    var Dt = function (e) {
      let t = e.title;
      var n = e.body;
      var r = e.link;
    ...
    const Yt = l.c.div(qt(), (e) => e.backgroundImage.image);
    var Gt = l.c.div(Vt());
    var Kt = l.c.h3(Wt(), h.orange, h.small);
    var Qt = function (e) {
      let t = e.id;
      var n = e.backgroundImage;
      var r = e.getToKnow.map((e) => a.a.createElement(Ht, { getToKnow: e }));
      return a.a.createElement(
        Yt,
    ...
    function nn(e) {
      for (let t = 1; t < arguments.length; t++) {
        ...
        t % 2
          ? tn(Object(n), !0).forEach((t) => {
            Zt(e, t, n[t]);
          })
          : Object.getOwnPropertyDescriptors
            ? Object.defineProperties(e, Object.getOwnPropertyDescriptors(n))
            : tn(Object(n)).forEach((t) => {
    ...
    function un(e, t) {
      return !t || (typeof t !== 'object' && typeof t !== 'function') ? sn(e) : t;
    }
    function cn(e) {
      return function () {
        let t;
    ...
    function Cn(e, t, n) {
      return e.concat(t).map((e) => En(e, n));
    }
    function Tn(e, t, n) {
        ...
        return (
          Jt(r, [
            ...
            },
            {
              ...
              value() {
                var t = this;
                    var n = Hn(this.state, this.props);
                return a.a.createElement(
                  e,
                  en(
                    {
    ...
    const Pn = 'SECRET_DO_NOT_PASS_THIS_OR_YOU_WILL_BE_FIRED';
          ...
          },
          {
            ...
            value() {
              var e = this.props;
                  ...
                  var o = gn([Fn, "carousel__back-button", n]);
                  var l = t.setDisabled(
                  this.props.disabled,
    ...
    (jn.arguments = jn['bit-array'] = jn.array = xn((e, t, n) => {
      let r = e.length;
    ...
    Tn.all = function (e, t) {
      ...
      return e.reduce((e, n) => Tn(e, n, t), {});
    };
    let Bn;
    var Un;
    var Hn = Tn;
    var Wn = a.a.createContext();
    var Vn = function e(t) {
      return (
        Object.freeze(t),
    ...
    var qn = { masterSpinnerFinished: !1 };
    var Yn = (function () {
      function e(t) {
        $t(this, e),
          ...
          },
          {
            ...
            value() {
              var e = this.props;
                    ...
                    var r = gn(['carousel', this.props.className]);
              return a.a.createElement(
                t,
                en({ className: r }, n),
                a.a.createElement(
            ...
            },
            {
              ...
              value: function () {
                var e = this.props;
                    ...
                    var c = gn([sr, "carousel__next-button", n]);
    ...
    var Tr = 'spinner___27VUp';
    var Or =        ((br = vr = (function (e) {
          function t() {
            return $t(this, t), n.apply(this, arguments);
          }
          rn(t, a.a.PureComponent);
            ...
            },
            {
              ...
              value() {
                var e = t.slideSizeInPx(
                    ...
                    var a = Nn({ min: 0, max: r, x: this.props.currentSlide + n });
                this.props.infinite
    ...
    const Hr = l.c.div(Ur());
    var Wr = l.c.div(Br());
    var Vr = l.c.div(Lr(), h.purple);
    var qr = l.c.div(zr(), (e) => {
        return e.theme.small;
      });
    var Yr = l.c.div(Rr());
    var Gr = l.c.div(jr(), h.medium);
    var Kr = l.c.div(Ir(), h.large);
    var Qr = l.c.h3(Dr(), h.purple);
    var $r = function (e) {
      var t = e.id;
          var n = e.slides;
      return a.a.createElement(
    ...
    function na(e) {
      return (na = "function" === typeof Symbol && typeof Symbol.iterator === 'symbol'
        ? function (e) {
          return typeof e;
        }
        : function (e) {
    ...
    function aa(e, t) {
      return !t || (na(t) !== 'object' && typeof t !== 'function') ? ra(e) : t;
    }
    function ia(e) {
    ...
    const pa = l.c.div(fa(), (e) => e.theme.medium);
    var ha = l.c.div(da(), h.large, h.large, (e) => {
    ...
    var xa = [
      ...
      { title: 'News Dev', members: ['Hong SengDu , NewsDev Deputy'] },
    ];
    var Sa = [
      {
        title: 'Corporate Board',
    ...
    const _a = l.c.a(Ma());
    var Na = l.c.h4(Aa(), h.navy);
    var Fa = l.c.img(Pa());
    var Da = l.c.div(Oa(), h.purple);
    function Ia(e) {
      const t = e.link;
      var n = e.photoAlt;
      var r = e.photoUrl;
    ...
    var Va = l.c.h2(La());
    var qa = l.c.div(za());
    var Ya = l.c.div(Ra(), h.medium, h.small);
    var Ga = function (e) {
      let t = e.title;
      var n = e.data;
      return a.a.createElement(
    ...
    const ri = l.c.div(ni());
    var ai = l.c.div(ti(), h.medium);
    var ii = l.c.div(ei(), h.medium);
    var oi = l.c.h2(Za());
    var li = l.c.p(Ja());
    var si = l.c.h2(Xa());
    var ui = l.c.div($a(), (e) => {
    ...
    var ci = l.c.a(Qa(), h.navy, h.medium);
    var di = l.c.div(Ka(), h.medium);
    var fi = [
    ...
    const ki = "https://arc-anglerfish-arc2-prod-spectator.s3.amazonaws.com/public/ZKALKJLFQFECNGLNTICSJUMFF4.png";
    var Ei = l.c.div(Si(), h.navy, h.navy, h.large, h.yellow, h.large);
    var Ci = l.c.div(xi(), h.large);
    var Ti = l.c.a(wi(), h.large);
    var Oi = l.c.div(yi(), h.yellow, h.large);
    var Pi = l.c.img(bi(), h.large);
    var Ai = l.c.div(vi());
    var Mi = l.c.div(gi());
    var _i = {
      bmBurgerButton: {
    ...
    var Wi = function (e) {
      ...
      return a.a.createElement(
        zi,
        null,
        a.a.createElement(Ui, null, t),
        a.a.createElement(
          Li,
          null,
          a.a.createElement(Hi, {
            src:
                'https://cloudfront-us-east-1.images.arcpublishing.com/spectator/3M5WSGYV7NEMVCJWW4I3I6QGTA.png'
          }),
        ),
        a.a.createElement(
          Bi,
          ...
          a.a.createElement(Hi, {
            src:
                'https://cloudfront-us-east-1.images.arcpublishing.com/spectator/YMGAQK7NCFFIFL4OYEIDHZ6CTE.png'
          }),
        ),
      );
    };
    ...
    var $i = [
      ...
      { title: '24 TRADITIONS', linkUrl: '/#/traditions' },
    ...
    var Zi = function () {
      return a.a.createElement(Ga, { title: 'ACADEMICS', data: Gi });
    };
    var eo = function () {
      return a.a.createElement(Ga, { title: 'ZOOM UNIVERSITY', data: Qi });
    };
    var to = function () {
      return a.a.createElement(Ga, { title: 'STUDENT LIFE', data: Ki });
    };
    var no = function () {
      return a.a.createElement(Ga, {
    ...
    var ro = function () {
      return a.a.createElement(Ga, { title: 'CAMPUS LIFE', data: Yi });
    };
    var ao = function () {
      return a.a.createElement(hi, { title: 'TEXTBOOK LINKS' });
    };
    var io = function () {
      return a.a.createElement(Wi, { title: '' });
    };
    const oo = function () {
      return a.a.createElement(
        l.a,
        ...
        a.a.createElement(
          a.a.Fragment,
          null,
          a.a.createElement(Ni, { entries: $i }),
          a.a.createElement(m, null),
          a.a.createElement(
            s.g,
            null,
            a.a.createElement(s.d, { exact: !0, path: '/', component: Xi }),
    ...
    const lo = n(12);
    o.a.render(
      a.a.createElement(lo.HashRouter, null, a.a.createElement(oo, null)),
...
// # sourceMappingURL=main.0a005aec.js.map
