    ...
    (function (e) {
      ...
      var re = function (e, t) {
        return function () {
          var n;
              var r =
                (((n = {})[A] = X(t)), (n["data-styled-version"] = "4.4.1"), n);
              var a = G();
          return (
            a && (r.nonce = a),
            s.a.createElement(
        ...
        return (
          (e.prototype.rehydrate = function () {
            ...
            for (let i = 0; i < a; i += 1) {
              ...
              for (
                var l,
                  s = (o.getAttribute(A) || '').trim().split(se),
                  u = s.length,
                  c = 0;
                c < u;
                c += 1
...
i;
      ...
      function et(e, t, n) {
        ...
        var g =            r && e.attrs
              ...
              : h;
        var v = new Ae(r ? e.componentStyle.rules.concat(n) : n, g, m);
        var y = void 0;
        var x = function (e, t) {
          return s.a.createElement(
            d,
 ...
 ...a, attrs: g, componentId: i, ParentComponent: d },
            ...
            return (
              i.a.Children.forEach(e.props.children, (e) => {
                if (null == r && i.a.isValidElement(e)) {
                  ...
                  r = o
                    ? P(a.pathname, Object(u.a)({}, e.props, { path: o }))
                    : t.match;
                }
              }),
  ...
  function (e, t, n) {
    ...
    function k(e) {
      ...
      function z(e) {
        (R += e) === 1 && e === 1
          ? (window.addEventListener(w, P), a && window.addEventListener(x, M))
          : R === 0
              ...
              if (n)
                if ((t.pushState({ key: i, state: o }, null, r), l))
                  ...
                  var s = D.indexOf(B.location.key),
                    u = D.slice(0, s + 1);
                  u.push(a.key), (D = u), A({ action: "PUSH", location: a });
                }
      ...
      return o.a.createElement(r.h.Consumer, null, (e) => {
        ...
        var n = v || e.location,
          ...
          M = P
            ...
            : f,
          _ = P ? Object(s.a)({}, k, {}, d) : k,
          N = Object(s.a)(
            { "aria-current": (P && a) || null, className: M, style: _, to: i },
            T
          );
        return (
    ...
    e.exports = (function e(t) {
          ...
          if (
            ...
            if (Ee === 1) {switch (y) {
                ...
                case W:
                  break;
                default:
                  for (Ee = 0, Oe = Y, v = y, Y--, y = N; Oe < Ae;) switch (a.charCodeAt(Oe++)) {
                      case L:
                      case B:
                      case N:
                        ++Y, (y = v), (Oe = Ae);
            ...
            case L:
              ...
              d === Z
                ...
                : ve + T === 0
                  ...
                  && Ge.length > 0
                  && ((we = 1), (Ge += '\0')),
              Ce * Fe > 0 && Ve(Pe, Ge, t, e, me, he, Qe.length, i, o, i),
              (he = 1),
              me++;
              break;
            case N:
      ...
      function Ue(e, t, n, r) {
        ...
        if (f === 944) {return (function (e) {
            ...
            return (
              (a = `${r + a  };`),
              be === 1 || (be === 2 && He(a, 1)) ? P + a + a : a
            );
          }(d));}
        if (be === 0 || (be === 2 && !He(d, 1))) return d;
        switch (f) {
          case 1015:
            return d.charCodeAt(10) === 97 ? P + d + d : d;
          case 951:
            return d.charCodeAt(3) === 116 ? P + d + d : d;
          case 963:
            return d.charCodeAt(5) === 110 ? P + d + d : d;
          case 1009:
          ...
          case 932:
            if (d.charCodeAt(4) === q) {switch (d.charCodeAt(5)) {
                ...
                case 115:
                  return P + d + _ + d.replace('shrink', 'negative') + d;
                case 98:
                  return P + d + _ + d.replace('basis', 'preferred-size') + d;
              }}
            return P + d + _ + d + d;
          case 964:
            return `${P + d + _ }flex-${d}${d}`;
          case 1023:
            ...
            return (
              ...
              `${P }box-pack${u }${P}${d }${_ }flex-pack${u }${d}`
            );
          case 1005:
            return i.test(d)
              ? d.replace(a, `:${  P}`) + d.replace(a, `:${  M}`) + d
              : d;
          case 1e3:
            switch (
          ...
          case 975:
            switch (
              ...
              case 207:
              case 102:
                d = d.replace(u, `${P + (f > 102 ? 'inline-' : '') }box`)
                  + ';'
                  + d.replace(u, P + u)
                  + ';'
                  + d.replace(u, `${_ + u}box`)
          ...
          case 938:
            if (d.charCodeAt(5) === q) {switch (d.charCodeAt(6)) {
                case 105:
                  return (
                    (u = d.replace('-items', '')),
                    `${P + d + P  }box-${  u  }${_  }flex-${  u  }${d}`
                  );
                case 115:
                  return `${P + d + _  }flex-item-${  d.replace(C, "")  }${d}`;
                default:
                  return (
                    `${P +
                    d +
          ...
          case 962:
            if (
              ((d = P + d + (d.charCodeAt(5) === 102 ? _ + d : '') + d),
              n + r === 211
                && d.charCodeAt(13) === 105
      ...
      function Ge(t, n) {
        ...
        var l = [Re];
        Ce > 0
          && void 0 !== (o = Ve(Ae, n, l, l, me, he, 0, 0, 0, 0))
          && 'string' === typeof o
          && (n = o);
        let s = ze(ke, l, n, 0, 0);
        return (
  ...
  function (e, t, n) {
    ...
    function ft(e) {
      ...
      do {
        ...
        if (!r) break;
        ((t = n.tag) !== 5 && t !== 6) || e.ancestors.push(n), (n = An(r));
      } while (n);
            ...
            !(function (e, t, n, r, a) {
              switch (t) {
                ...
                case 'gotpointercapture':
                  return (
                    (i = a.pointerId),
                    kt.set(i, Pt(kt.get(i) || null, e, t, n, r, a)),
                    !0
                  );
              }
              return !1;
    ...
    var Aa = i.unstable_ImmediatePriority;
    var Pa = i.unstable_UserBlockingPriority;
    ...
    function qa(e) {
      return ja === null ? ((ja = [e]), (Ra = ka(Aa, Ga))) : ja.push(e), Fa;
    }
    function Ya() {
      if (Ra !== null) {
        const e = Ra;
    ...
    function Ga() {
      if (!za && ja !== null) {
        ...
        try {
          ...
          throw (ja !== null && (ja = ja.slice(e + 1)), ka(Aa, Ya), n);
        } finally {
          za = !1;
        }
      }
    ...
    function Ni(e, t) {
      switch ((ca(Mi, t), ca(Pi, e), ca(Ai, Oi), (e = t.nodeType))) {
        case 9:
        case 11:
    ...
    function Di(e) {
      _i(Mi.current);
      const t = _i(Ai.current);
      var n = je(t, e.type);
      t !== n && (ca(Pi, e), ca(Ai, n));
    }
    function Ii(e) {
      Pi.current === e && (ua(Ai), ua(Pi));
    }
    const ji = { current: 0 };
    function Ri(e) {
      for (let t = e; t !== null;) {
      ...
      switch (t.tag) {
        ...
        case 3:
          return (
            ...
            (e !== null && e.child !== null) || !Ao(t) || (t.effectTag |= 4),
            Ho(t),
            null
          );
        case 5:
            ...
            if (((e = _i(Ai.current)), Ao(t))) {
              ...
              switch (
                ...
                case 'select':
                  ...
                  break;
                case 'textarea':
                  Me(e, r), (u = Pe(e, r)), Yt('invalid', e), an(n, 'onChange');
                  break;
                default:
                  u = r;
              }
    ...
    function sl(e, t, n) {
      switch ((typeof Ps === 'function' && Ps(t), t.tag)) {
        case 0:
        case 11:
        case 14:
        case 15:
    ...
    function Os(e, t, n) {
      ...
      r !== null && r.delete(t),
      Fl === e && Il === n
        ? jl === Ml || (jl === Pl && zl === 1073741823 && Ba() - Wl < Vl)
          ? ds(e, Il)
          : (Hl = !0)
        : Ls(e, n)
      ...
      if (void 0 !== t) {
        ...
        if (n !== t) {
          ...
          for (let r = 0, a = e.length; r < a;) {
            ...
            var l = i + 1;
            var s = e[l];
            if (void 0 !== o && A(o, n) < 0) {void 0 !== s && A(s, o) < 0
                ? ((e[r] = s), (e[l] = n), (r = l))
                : ((e[r] = o), (e[i] = n), (r = i));}
            else {
              if (!(void 0 !== s && A(s, n) < 0)) break;
              (e[r] = s), (e[l] = n), (r = l);
            }
          }
        }
    ...
    function R(e) {
      for (let t = T(M); t !== null;) {
        if (t.callback === null) O(M);
          ...
          O(M), (t.sortIndex = t.expirationTime), C(P, t);
        }
        t = T(M);
      }
    }
    function z(e) {
      if (((j = !1), R(e), !I)) {if (T(P) !== null) (I = !0), r(L);
        else {
          let t = T(M);
      ...
      try {
        for (
          ...
          if (l !== null) {
            ...
            (n = t.unstable_now()),
            'function' === typeof s ? (N.callback = s) : N === T(P) && O(P),
            R(n);
          } else O(P);
          N = T(P);
        }
    ...
    (t.unstable_scheduleCallback = function (e, n, o) {
      ...
      return (
        ...
        s > l
          ? ((e.sortIndex = s),
          C(M, e),
          T(P) === null && e === T(M) && (j ? i() : (j = !0), a(z, s - l)))
          : ((e.sortIndex = o), C(P, e), I || D || ((I = !0), r(L))),
        e
      );
    }),
      ...
      let a = (function (e) {
        function t(e, r) {
          if (e) {
            ...
            if (A(e, 'array') && t.set) return t.set.apply(t, e);
 ...
 r: -1, g: -1, b: -1, hex: 'none', error: 1, toString: D 
        ...
        var j = function (e, n, r, a) {
          let i = {
            ...
            g: (n = l.round(255 * n)),
            b: (r = l.round(255 * r)),
            opacity: A(a, 'finite') ? a : 1,
            hex: t.rgb(e, n, r),
            toString: D,
          };
          return A(a, 'finite') && (i.opacity = a), i;
        };
        (t.color = function (e) {
          let n;
          return (
            A(e, 'object') && 'h' in e && 's' in e && 'b' in e
              ? ((n = t.hsb2rgb(e)),
              (e.r = n.r),
              (e.g = n.g),
              (e.b = n.b),
              (e.opacity = 1),
              (e.hex = n.hex))
              : A(e, 'object') && 'h' in e && 's' in e && 'l' in e
                ? ((n = t.hsl2rgb(e)),
                (e.r = n.r),
                (e.g = n.g),
                (e.b = n.b),
        ...
        (t.parsePathString = function (e) {
          ...
          var i = [];
          return (
            A(e, 'array') && A(e[0], 'array') && (i = t.path.clone(e)),
            i.length
                || a(e).replace(b, (e, t, n) => {
                  let a = [];
                    var o = t.toLowerCase();
        ...
        const R = (t.parseTransformString = function (e) {
          ...
          let n = [];
          return (
            A(e, 'array') && A(e[0], 'array') && (n = t.path.clone(e)),
            n.length
              || a(e).replace(y, (e, t, r) => {
                let a = [];
                t.toLowerCase();
        ...
        (t.ajax = function (e, t, n, r) {
          ...
          var i = k();
          if (a) {
            if (A(t, 'function')) (r = n), (n = t), (t = null);
            else if (A(t, 'object')) {
              let o = [];
                    ...
                    function t(n, r, a, i, o, l, s, u, f, p) {
                      ...
                      if (p) (A = p[0]), (P = p[1]), (T = p[2]), (O = p[3]);
                        ...
                        var k = a * a;
                            ...
                            var T = (C * a * x) / i + (n + u) / 2;
                            var O = (C * -i * w) / a + (r + f) / 2;
                            var A = c.asin(((r - O) / i).toFixed(9));
                            var P = c.asin(((f - O) / i).toFixed(9));
                        (A = n < T ? d - A : A) < 0 && (A = 2 * d + A),
                        (P = u < T ? d - P : P) < 0 && (P = 2 * d + P),
                        s && A > P && (A -= 2 * d),
                        !s && P > A && (P -= 2 * d);
                      }
                      var M = P - A;
...
s;
 ...
 color: a, dx: t, dy: n, blur: r, opacity: i 
  ...
  function (e, t, n) {
    ...
    var B = l.c.p(P(), p.large);
    var U = l.c.h1(A(), p.large);
    var H = l.c.h2(O());
    var W = function (e) {
      var t = e.tocEntries;
      return a.a.createElement(
    ...
    function Ke(e) {
      ...
      return a.a.createElement(
        ...
        a.a.createElement(Ye, { alt: n, src: r }),
        a.a.createElement(qe, null, i),
        a.a.createElement(Ge, { linkColor: o }, '| Click to read more'),
      );
    }
    ...
    var Tt = l.c.div(yt());
    var Ot = l.c.div(bt());
    var At = l.c.h3(vt(), p.medium);
    var Pt = l.c.div(gt(), p.medium);
    var Mt = l.c.p(mt());
    var _t = l.c.a(ht());
    ...
    var Bt = function (e) {
      ...
      return a.a.createElement(
        ...
        a.a.createElement(zt, null, a.a.createElement(Lt, null, n)),
      );
    };
    var Ut = Bt;
    function Ht() {
    ...
    Bt.defaultProps = { getToKnow: 'error' };
    const qt = l.c.div(Vt(), (e) => e.backgroundImage.image);
    var Yt = l.c.div(Wt());
    var Gt = l.c.h3(Ht(), p.orange, p.small);
    var Kt = function (e) {
      let t = e.id;
      ...
      return a.a.createElement(
        ...
        a.a.createElement(Gt, null, 'GET TO KNOW'),
        a.a.createElement(Yt, null, r),
      );
    };
    function Qt(e, t) {
      if (!(e instanceof t)) throw new TypeError('Cannot call a class as a function');
    ...
    var mr = (function (e) {
      function t(e) {
        ...
        return (
          Qt(this, t),
          ((r = n.call(this, e)).state = { imageStatus: Pn }),
    ...
    var Tr =        ((vr = gr = (function (e) {
        ...
        Zt(gr, 'propTypes', { className: An.string }),
            ...
            },
            {
              ...
              value: function () {
                ...
                var w = { ...b, ...f},
                  ...
                  k = mn([Ar.slideInner, 'carousel__inner-slide', o]),
    ...
    var qr = l.c.div(jr());
    var Yr = l.c.div(Ir(), p.medium);
    var Gr = l.c.div(Dr(), p.large);
    ...
    const ri = l.c.div(ni());
    var ai = l.c.div(ti(), p.medium);
    var ii = l.c.div(ei(), p.medium);
    var oi = l.c.h2(Ja());
    var li = l.c.p(Za());
    var si = l.c.h2(Xa());
    var ui = l.c.div($a(), (e) => {
    ...
    var ci = l.c.a(Qa(), p.navy, p.medium);
    var di = l.c.div(Ka(), p.medium);
    var fi = [
    ...
    var Ei = l.c.div(Si(), p.navy, p.navy, p.large, p.yellow, p.large);
    var Ci = l.c.div(xi(), p.large);
    var Ti = l.c.a(wi(), p.large);
    var Oi = l.c.div(yi(), p.yellow, p.large);
    var Ai = l.c.img(bi(), p.large);
    var Pi = l.c.div(vi());
    var Mi = l.c.div(gi());
    var _i = {
      bmBurgerButton: {
    ...
    var Ui = function () {
      return a.a.createElement(Ya, {
        title: 'GET TO KNOW BARNUMBIA',
        data: Fi,
      });
    };
    var Hi = function () {
      return a.a.createElement(Ya, { title: 'ACADEMICS', data: ji });
    };
    var Wi = function () {
      return a.a.createElement(Ya, { title: 'ZOOM UNIVERSITY', data: zi });
    };
    var Vi = function () {
      return a.a.createElement(Ya, { title: 'STUDENT LIFE', data: Ri });
    };
    var qi = function () {
      return a.a.createElement(Ya, {
    ...
    var Yi = function () {
      return a.a.createElement(Ya, { title: 'CAMPUS LIFE', data: Ii });
    };
    var Gi = function () {
...
// # sourceMappingURL=main.b41f7b75.js.map
